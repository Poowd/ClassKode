            ...
            <div className="d-flex align-items-center gap-2">
                                ...
                                list={
                                    <>
                                        ...
                                        <SidebarItem
                                            ...
                                            classlink={"py-2"}
                                            icon={
                                                info.icons.modules.academicyear
                                            }
                ...
                <div className="d-flex gap-2">
                    <h5 className="p-0 m-0">
                        <span className="fw-bold gradient-text-golden">
                            ClassKode
                        </span>
                    </h5>
                    <div>
                        <p className="p-0 m-0">
                            <span className="fw-semibold gradient-text-3">
                                Manager
                            </span>
                        </p>
                    </div>
