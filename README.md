...
1. IMPLEMENTATION OF THE ACADAEMIC YEAR MODULE THAT WILL HANDLE THE FOLLOWING DATA:
   - ACADEMIC YEAR ( BASE )
   - COACH ASSIGNMENT
   - COACH SPECIALIZATION
   - SECTION PROJECTION
1. STARTING THE TEMPLATE FOR SCHEDULE AND GENERATE SCHEDULE MODULE
1. WITH THE IMPLEMENTATION OF THE FOLLOWING MODULE DATABASE IS ALSO ADJUSTED TO SEE FIT.
1. MINOR CHANGES IN USER INTERFACE INCLUDING THE STI MAP ( CHANGED AS AN HTML STRUCTURE FOR )

### LOG ENTRY 13 - 28/06/2024

1. LIST CARD ADJUSTMENTS
2. ACADEMIC YEAR FUNCTIONALITIES SUCH AS ADD ENTRY
3. GENERATE SCHEDULE TEMPLATE
4. ACADEMIC YEAR VIEW
5. ACADEMIC YEAR QUERIES

### LOG ENTRY 14 - 29/06/2024

1. MULTI-SELECTION TOOL FOR ASSIGNMENT
2. MULTI-SELECTION TOOL FOR PROJECTION
3. PERSISTING DATA FOR SETUP UTILIZING LOCAL STORAGE
4. DATABASE ADJUSTMENTS
5. CREATED FORMS FOR THE FOLLOWING:
   - ASSIGMENT
   - PROJECTION
   - SETUP
6. ADJUSTMENTS FOR ACADEMIC YEAR ( ASSIGNMENT AND PROJECTION )
7. ADJUSTMENTS FOR CURRICULUM
   - NOW HAS THE CURRICULUM LIST AND SETUP IS MOVED
...
1. ADDITIONAL ENTRIES AND MODIFICATIONS FOR THE FOLLOWING TABLES:
   - PROJECTION
   - ASSIGNMENT

### LOG ENTRY 17 - 2/07/2024

1. MINOR ADJUSTMENTS FOR THE ACADEMIC YEAR
2. ADDED NEW VIES FOR THE ACADEMIC YEAR:
   - ASSIGNMENT
   - PROJECTION
3. MULTI-ENTRY ADDITION FOR THE ACADEMIC YEAR ASSIGNMENT AND PROJECTION
4. SHOULD ADD INTUITIVITY FOR THE MULTI-ENTRY
...
### LOG ENTRY 19 - 3/07/2024 - 9/07/2024

1. DEVELOPMENT IS ON PAUSE, HANGOUT WITH FRIENDS AND MY LOVE 🥇

### LOG ENTRY 20 - 10/07/2024

1. CONTINUEING THE IMPLEMENTATION AND DEVELOPMENT
2. RE-DEVELOPMENT STI MAP AND THE LOADING NOW WILL CONTAIN THE FOLLOWING ATTRIBUTES:
   - CONTAINERS WILL CARRY A SPECIFIC BUTTON THAT CAN BE CLICKED
   - ONCE CLICKED, THIS WILL SHOW THE CURRENT SCHEDULES FOR THAT ROOM
   - ROOM CONTAINERS ARE NOW ORGANIZED IN ROWS AND COLUMNS
   - NOT REALISTICALLY ACCURATE BUT EACH LOCATION REMAINS THE SAME
   - DIMENSIONS ARE NOT ACCURATE AS WELL
   - CONTAINERS WILL CARRY THE FOLLOWING ATTRIBUTES:
     - NAME OF THE ROOM
     - CAPACITY
     - STATUS
   - ON THE SECOND COLUMN, STI MAP NAVIGATION
   - SEPARATED THE WHOLE CAMPUS INTO DIFFERENT PARTS SUCH AS BUILDINGS AND FLOORS
   - THIS WILL HAVE THE FOLLOWING CATEGORIES FOR BOTH BUILDING AND FLOOR
3. ADJUSTMENTS FOR EACH DATABASE TABLES SUCH AS ATTRIBUTE NAMES AND SPECIFICATIONS
4. ADDED DATABASE TABLES SUCH AS WEEKLYEVENTS AND SETTINGS
5. IMPROVED ACADEMIC YEAR AND CURRICULUM MERGING, NOW HAS FEWER ACTIONS
6. UTILIZATION OF JOINS FOR THE CURRICULUM SETUP AND SECTION PROJECTIONS
7. ADDED TIME FORMATTING IN COMPATABILITY WITH MINUTES STANDARD TIME SETUP
8. ADJUSTED USER INTERFANCE SETUP, ADDITION OF THE DROPDOWN CATEGORIES
9. DYNAMIC LIST CARD FOR DIFFERENT TYPES OF LIST FOR BOTH INSTITUTION AND UTILITIES
10. SOME QUALITY OF LIFE FEATURES ARE ADDED LIKE PROCEDURAL NAVIGATION FOR THE SYSTEM
11. MAJOR ENTITY RELATION DIAGRAM CHANGES, THIS SHOULD FIT FOR THE CURRENT SETUP OF THE APPLICATION
12. INITIAL GENERATION OF SCHEDULES WITH THE FOLLOWING FEATURES:
    - SECTION
    - COURSE
    - ROOM
    - DAY
    - TIME
13. GENERATION OF SCHEDULES IS NOT IMPLEMENTED AT THE SERVER SIDE YET
14. GENERATION OF SCHEDULES CURRENTLY HANDLES THE FOLLOWING CONSTRAINTS:
    - POPULATION <= CAPACITY
    - COMPONENTS SHOULD INCLUDE FACILITY
    - DAY AND TIME FOR EACH ROOM
15. CURRENTLY THE SCHEDULE SHOULD REQUIRE THE FOLLOWING CONSTRAINTS:
    - 1 LABORATORY PER DAY PER SECTION
    - SECTION SCHEDULE SHOULD BE BALANCED THROUGHOUT THE DAY
    - SECTION SHOULD NOT EXIST WITHIN DIFFERENT ROOM AT THE SAME DAY AND TIME
    - COACHES SHOULD NOT EXIST WITHIN DIFFERENT CLASS AT THE SAME DAY AND TIME

### LOG ENTRY 21 - 11/07/2024 - 12/07/2024

1. MINOR ADJUSTMENTS ONLY NOTHING IMPORTANT

### LOG ENTRY 22 - 13/07/2024

1. SUPPOSED TO BE SWIMMING
2. BEBETIME

### LOG ENTRY 23 - 14/07/2024

1. MAIN AREA FOCUSED IS THE SCHEDULES MODULE
2. CAN ALREADY GENERATE A PARTIAL SCHEDULE WITH THE FOLLOWING CURRENT STATE:
   - GENERATE SCHEDULE WITH THE FOLLOWING:
   - SECTION
   - COURSE
   - ROOM
   - CURRENTLY THERE ARE NO OCCURING CONFLICTS WITH THE EXISTING VARIABLES
   - COACHES ARE NOT YET IMPLEMENTED
   - NOT YET TRANSFER TO SERVER SIDE
   - FILTER AND ASSUMED DETAILS ARE NOT YET DONE
3. SCHEDULES TIMETABLE SETUP ARE IMPLEMENTED, INITIAL DESIGN ARE JUST IMPROVEMENTS FROM THE PREVIOUS VERSION
4. THE SCHEDULES STILL DOES NOT FOLLOW CURRENT ACADEMIC YEAR YET
5. SECTION AND ROOM LOADING ARE ALMOST DONE
6. ROOM LOADING STILL REQUIRES MAP FOR MAIN BUILDING
7. SEARCH FOR SECTION LOADING IS IMPLEMENTED
8. UPDATED THE FORMAT FOR THE LOADING, NOW HAS THE CAPABILITY TO MOVE ENTRIES ONE BY ONE ( PREVIOUS AND NEXT VALUES )
9. ADDED A NEW GRADIENT BACKGROUND AND TEXT COLORS, TO BE POLISHED
10. UI ADJUSTMENTS IN-LINED WITH NEW BACKGROUND AND TEXT COLORS
11. STARTING TO UPDATE QUERIES TO FIT WITH SEARCH FEATURES
12. WILL BE ADDING TAGS FOR THE SEARCHES
13. UI ADJUSTMENTS TO FIT SCALE 175% ( OBSERVED MONITOR SCALE BASED FROM PAST DEFENSES )
14. REVISIONS FOR THE RENDERING OF STI MAPS IN-LINED WITH THE ADDITIONAL FEATURES FOR ( PREVIOUS AND NEXT VALUES )

### LOG ENTRY 24 - 15/07/2024 - 28/07/2024

1. STATUS QUO FOR THE GENERATION OF CLASSROOM, CAN NOW GENERALLY GENERATE SCHEDULES WITHOUT CONFLICTS AND BE ABLE TO ASSES IF THE ROOM IS LABORATORY / LECTURE
2. WILL BE MODIFYING THE COMPONENTS FOR THE LABORATORIES INTO THE ROOM ITSELF FOR BETTER ALGORITHM RESULTS
3. LECTURE COMPONENT WILL STAY THE SAME
4. UI DESIGN MODIFICATION INCLUDING GRADIENT COLORS
5. CODE CLEAN UP

### LOG ENTRY 25 - 29/07/2024 - 8/08/2024

1. MAJOR REVISIONS FOR THE OVERALL USER INTERFACE INCLUDING BUT IS NOT LIMITED TO COLOR, BACKGROUNDS, GRADIENTS, AND FIXES WITH THE SHAPES, SHADOWS, AND MORE.
2. ADDED FULLY FUNCTIONING ACADEMIC YEAR, CURRICULUM, AND SCHEDULES
3. ADDED NEW FACULTY LOCATOR
4. ADDED POP UP MENU FOR LOGOUT
5. ARCHIVE MODULES IS ALSO IMPLEMENTED WITH THE FOLLOWING DATA:
   - ALL INSTITUTION MODULES AND UTILITIES MODULE EXCLUDING FACULTY LOCATOR
6. IMPROVE QUERIES AND ORGANIZATION OF THE FILES
7. FILE MAINTAINANCE AND CODE CLEAN UPS
8. ADDED NEW FEATURE FOR COACHES:
   - CAN NOW PLACE A PICTURE ALONG WITH THE DETAILS
   - IMAGES ARE SAVED UNTO THE SERVER
   - PATH IS INCLUDED AND THE NAME OF THE IMAGE IS SAVED UNTO THE DATABASE
9. ROOM MAPPING FOR EACH AND EVERY BUILDING AND FLOORS DATABASE INCLUDED
10. ADDED A NEW TYPE OF BUTTON, COLLAPSE BUTTON. PRETTY MUCH LIKE ACCORDION BUT BETTER
11.
...
15/07/2024
![image](https://github.com/user-attachments/assets/1ff9e256-f009-4df0-a407-f1cd9cf125f0)
![image](https://github.com/user-attachments/assets/62d4793a-85ee-49df-b700-4b5f34329c16)
![image](https://github.com/user-attachments/assets/60c38db5-a15f-4f61-a4f7-b860388b0f68)
![image](https://github.com/user-attachments/assets/2460365a-e729-46eb-8d2f-42a977ae87b8)
![image](https://github.com/user-attachments/assets/b00eb3b9-3584-4667-9624-1152d7430938)
![image](https://github.com/user-attachments/assets/6283cfcd-bf83-4221-9bd7-10c1adc7f384)
![image](https://github.com/user-attachments/assets/05c9829f-bbb0-4008-b011-3a8d9071339b)
![image](https://github.com/user-attachments/assets/69173a83-4025-4a54-b2ce-ebac4285ef43)
![image](https://github.com/user-attachments/assets/efa484f1-4d3c-4ac9-be5a-24c0f905262f)
