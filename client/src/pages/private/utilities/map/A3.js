          ...
          <div className="col-6 m-0 p-0">
            <div className="h-100 p-0 m-0">
              <div className="h-25 p-0 m-0 pb-1">
                <div className="h-100 border rounded">cold kitchen</div>
              </div>
              <div className="h-75 p-0 m-0">
                <div className="h-50 p-0 m-0 pb-1">
                  <div className="h-100 border rounded">hot kitchen 1</div>
                </div>
            ...
            <div className="h-100 p-0 m-0">
              <div className="h-75 p-0 m-0">
                <div className="h-100 p-0 m-0 pb-1">
                  <div className="h-100 border rounded">dining room</div>
                </div>
              </div>
              <div className="h-25 p-0 m-0 pb-1">
